        ...
        $(function () {
            ...
            */
            ...
            $("#remarkDivList").on("click", "a[name = 'deleteA']", function () {
                var id = $(this).attr("remarkId");  // $(this)是该标签的dom对象，从dom对象中获取remarkId的值用attr()方法
                // 发送请求
                $.ajax({
    ...
    <div class="remarkDiv" style="height: 60px;">
        ...
        <div style="position: relative; top: -40px; left: 40px;">
            ...
            <font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small
                style="color: gray;">
            ${editFlag == '1' ? remark.editTime : remark.createTime}
            由${editFlag == '1' ? remark.editBy : remark.createBy}
            ${editFlag == '1' ? '创建' : '修改'}</small>
