    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#searchActivityTxt").keyup(function () {
                ...
                //发送请求
                $.ajax({
                    url: 'workbench/clue/queryActivityDetailByNameClue.do',
                    data: {
...
<div style="position: relative; top: -70px;">
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 60px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${requestScope.clue.createTime}&nbsp;&nbsp;</b><small
    ...
    <c:forEach items="${requestScope.remarkList}" var="remark">
        <div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
            ...
            <div style="position: relative; top: -40px; left: 40px;">
                ...
                <b>${requestScope.clue.fullname}-${requestScope.clue.appellation}-${requestScope.clue.company}</b>
                <small
                        style="color: gray;"> ${remark.editFlag == '0' ? remark.createTime : remark.editTime}
                    由${remark.editFlag == '0' ? remark.createBy : remark.editBy}
            ...
            <table class="table table-hover" style="width: 900px;">
                ...
                <c:forEach items="${requestScope.activityList}" var="activity">
                    <tr>
                        ...
                        <td><a href="javascript:void(0);" activityId="${activity.id}" style="text-decoration: none;">
