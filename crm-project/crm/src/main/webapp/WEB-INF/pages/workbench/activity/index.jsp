    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#saveCreateActivityBtn").click(function () {
                ...
                /*
                    ...
                    语法通则:
                        ...
                        3): [] 匹配指定字符集中的一个字符
                        4): {} 匹配次数
                        5): 特殊符号：\d: 匹配一位数字，\D: 匹配一位非数字，
                                    \w: 匹配所有字符，包括字母、数字、下划线；\W: 匹配所有非字符
            ...
            $("#tBody").on("click", "input[type = 'checkbox']", function () {
                ...
                } else { // 如果列表中的checkbox有一个没选中，则“全选”按钮也取消
            ...
            $("#importActivityBtn").click(function () {
                ...
                // FormData是ajax提供的接口，它可以模拟键值对向后台提交参数
                // FormData最大的优势是，它不仅可以提交文本数据，还可以提交二进制数据
